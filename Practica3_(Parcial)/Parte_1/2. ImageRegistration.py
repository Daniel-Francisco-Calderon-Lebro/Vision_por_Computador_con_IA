...
imgpath = '\s1a-iw-grd-vv-20240919t111136-20240919t111153-055733-06cebc-001.tiff' #Scaled image name and extension

#Start
imgtemplatepath = '\s1a-iw-grd-vv-20240826t111135-20240826t111152-055383-06c133-001_scaled.tiff' #Scaled image of reference
...
aligned = align_image(image, template, maxFeatures=500, keepPercent=0.5, debug=False)
